...
class HorseRaceApp:
    ...
    def add_horse(self, horse_type: str, horse_name: str, horse_speed: int):
        ...
        if horse_type in self.VALID_TYPES:
            horse = self.VALID_TYPES[horse_type](horse_name, horse_speed,)
    ...
    def start_horse_race(self, race_type: str):
        ...
        return f"The winner of the {race_type} race, with a speed of {highest_speed}km/h is {winner}! Winner's horse: {horse_name}."
